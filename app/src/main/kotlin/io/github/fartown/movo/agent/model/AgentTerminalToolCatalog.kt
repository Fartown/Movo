    ...
    fun appendTo(tools: JSONArray) {
        tools
                            ...
                            JSONObject()
                                ...
                                .put(
                                    ...
                                    JSONObject()
                                        ...
                                        .put("description", "android uses the native Android shell with BusyBox applets when available. linux uses the Alpine or Debian environment selected in Movo settings. Default android.")
                                )
                                .put(
                                    "command",
                                    JSONObject()
                                ...
                                .put(
                                    ...
                                    JSONObject()
                                        .put("type", "string")
                                        .put("description", "Working directory. Defaults to /data/local/tmp/movo for android and /workspace for linux. Relative paths use the environment default. ~/ means /storage/emulated/0.")
                                )
                                .put(
                                    "timeout_ms",
                                    JSONObject()
                        ...
                        .put(
                            ...
                            JSONObject()
                                ...
                                .put(
                                    ...
                                    JSONObject()
                                        .put("type", "string")
                                        .put("description", "工作目录，默认 /data/local/tmp/movo。相对路径也按该目录解析；用户存储可用 ~/ 表示 /storage/emulated/0。")
                                )
                                .put(
                                    "timeout_seconds",
                                    JSONObject()
            ...
            .put(
                AgentToolSchema.function(
                    name = "list_directory",
                    description = "列出 Android 目录内容。默认 /data/local/tmp/movo，输出类似 ls -l。",
                    parameters = JSONObject()
                        .put("type", "object")
                        .put(
                            "properties",
