...
import io.github.fartown.movo.data.db.RuntimeArchiveEventEntity
import io.github.fartown.movo.data.db.RuntimeArchiveRunEntity
import io.github.fartown.movo.data.db.RuntimeArchiveRunWithEvents
...
internal object AgentRunArchiveStore {
    ...
    fun list(context: Context): List<ArchivedRun> {
        ...
        return runBlocking(Dispatchers.IO) {
            MovoDatabase.get(appContext).runtimeRunDao().archivedRuns()
