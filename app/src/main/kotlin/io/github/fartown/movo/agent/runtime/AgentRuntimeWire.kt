...
internal object AgentRuntimeWire {
    ...
    const val ACTION_BIND = "io.github.fartown.movo.agent.runtime.BIND"
        ...
        readText: Boolean,
            ...
            config = AgentModelClient.ModelConfig(
                ...
                providerType = bundle.getString(KEY_PROVIDER_TYPE).orEmpty()
                    .ifBlank { io.github.fartown.movo.data.model.ProviderTypes.OPENAI_COMPATIBLE },
                ...
                anthropicVersion = bundle.getString(KEY_ANTHROPIC_VERSION).orEmpty()
                    .ifBlank { io.github.fartown.movo.data.model.AnthropicProviderSetting.DEFAULT_ANTHROPIC_VERSION },
                openAiEndpointMode = bundle.getString(KEY_OPENAI_ENDPOINT_MODE).orEmpty()
                    .ifBlank { io.github.fartown.movo.data.model.OpenAiEndpointMode.CHAT_COMPLETIONS },
