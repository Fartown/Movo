...
internal object ProotCommandBuilder {
    ...
    fun payload(
        ...
        val native = nativeDirectory ?: return "echo MOVO_PROOT_UNAVAILABLE >&2; exit 127"
        ...
        return "[ -x ${shellQuote(proot)} ] && [ -x ${shellQuote(loader)} ] || { echo MOVO_PROOT_UNAVAILABLE >&2; exit 127; }; " +
