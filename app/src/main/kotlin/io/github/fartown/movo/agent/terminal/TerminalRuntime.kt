...
internal object TerminalRuntime {
    ...
    } ?: File(System.getProperty("java.io.tmpdir"), "movo-terminal-workspace").absolutePath
    val temporaryDirectory: File get() = appContext?.let { File(it.cacheDir, "terminal/proot") }
        ?: File(System.getProperty("java.io.tmpdir"), "movo-proot")
    ...
    fun workspace(identity: String): String =
        if (identity == "root") "/data/local/tmp/movo" else userWorkspacePath
