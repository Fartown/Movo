...
import io.github.fartown.movo.agent.device.DeviceControlUnavailableException
...
import io.github.fartown.movo.agent.model.AgentScreenObservationContract
import io.github.fartown.movo.agent.model.AgentSensitiveToolPolicy
...
import io.github.fartown.movo.agent.runtime.AgentAppContext
...
import io.github.fartown.movo.agent.skill.SkillPackageInstaller
import io.github.fartown.movo.agent.skill.SkillParser
import io.github.fartown.movo.agent.skill.SkillResourceReader
...
import io.github.fartown.movo.agent.skill.GitHubSkillInspection
import io.github.fartown.movo.agent.skill.GitHubSkillRepository
...
import io.github.fartown.movo.agent.terminal.AlpineEnvironmentPaths
...
import io.github.fartown.movo.agent.terminal.RootShellTerminalController
...
import io.github.fartown.movo.core.HookSupport
import io.github.fartown.movo.data.repository.AgentMemoryException
import io.github.fartown.movo.data.repository.AgentMemoryMutation
...
internal class AgentLocalTools(
    ...
    private fun inspectionResult(
        inspection: io.github.fartown.movo.agent.skill.GitHubSkillInspection,
    ): String {
    ...
    private fun showInputTarget() {
        runCatching {
            val focused = io.github.fartown.movo.agent.accessibility.AgentAccessibilityService.current()
                ?.rootInActiveWindow
