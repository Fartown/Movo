 ...
 */
internal class MovoMicSessionCoordinator(
    ...
    /** @return true if Movo's visibility changed. */
    ...
    /** Scope is limited to Movo's own screens and none is visible. */
     ...
     * and only while Movo is visible unless the user chose to listen over other apps.
     */
