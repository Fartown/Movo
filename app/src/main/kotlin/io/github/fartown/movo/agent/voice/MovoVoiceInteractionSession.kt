 ...
 * 否则由 [io.github.fartown.movo.ui.AgentConversationSheetActivity] 承载界面。
 */
internal class MovoVoiceInteractionSession(context: Context) : VoiceInteractionSession(context) {
    ...
    override fun onBackPressed() {
        MovoAssistantVoiceService.dismiss(context)
        hide()
    }
    ...
    internal companion object {
        private const val ACTION_HIDE_FOR_FOREGROUND_OPERATION =
            "io.github.fartown.movo.agent.voice.HIDE_FOR_FOREGROUND_OPERATION"
