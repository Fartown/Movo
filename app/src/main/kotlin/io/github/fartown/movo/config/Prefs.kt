 ...
 * - Movo Runtime 自己消费的开关保存在 App 私有配置中，不依赖 Xposed Service。
...
internal object Prefs {
    ...
    const val GROUP = "movo_prefs"

    private const val LOCAL_AGENT_GROUP = "movo_agent_preferences"
    ...
    object Keys {
        ...
        /** 由 Movo Runtime 最终裁决、不要求 Xposed 框架在线的开关。 */
