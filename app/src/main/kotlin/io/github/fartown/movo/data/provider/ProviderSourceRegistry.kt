...
import io.github.fartown.movo.data.model.runtimeProviderType
...
internal object ProviderSourceRegistry {
    ...
    private fun sourceTypeFromProviderId(providerId: String?): String? =
        when (providerId) {
            ...
            BuiltinProviders.CHATGPT_ID -> ProviderSourceTypes.CHATGPT
    ...
    private fun sourceTypeFromBaseUrl(baseUrl: String?): String? {
        ...
        return when {
            ...
            httpUrl.host == "chatgpt.com" -> ProviderSourceTypes.CHATGPT
