package io.github.fartown.movo.hook.breeno
...
import io.github.fartown.movo.core.HookRegistrar
...
import io.github.fartown.movo.hook.MovoInjectedStrings
...
internal object BreenoHooks {
    ...
    ): String = MovoInjectedStrings.get(context, resourceId, englishFallback, *formatArgs)
    ...
    private const val INJECTED_MARKER_KEY = "movoAgent"
    ...
    private val modelExecutor = ThreadPoolExecutor(
        ...
        { runnable ->
            Thread(
                runnable,
                "Movo-AgentBridge-${agentBridgeThreadId.incrementAndGet()}"
            ).apply { isDaemon = true }
        },
                ...
                val modelResponse = runCatching {
                    ...
                    if (!Prefs.isEnabled(Prefs.Keys.AGENT_CUSTOM_MODEL)) {
                        error(injected(
                            ...
                            "Enable Breeno custom models in Movo settings first",
                        ))
                    }
