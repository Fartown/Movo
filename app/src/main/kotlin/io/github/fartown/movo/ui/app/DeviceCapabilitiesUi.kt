...
import io.github.fartown.movo.agent.device.RootAccessState
import io.github.fartown.movo.agent.device.RootAccessStatus
...
internal fun rememberDeviceCapabilities(): DeviceCapabilitiesUi {
    ...
    var xposedConnected by remember { mutableStateOf(MovoApp.serviceInstance != null) }
    ...
    DisposableEffect(owner, context) {
        ...
        onDispose {
            MovoApp.removeServiceStateListener(listener)
