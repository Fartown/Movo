package io.github.fartown.movo.ui.screens.backup
...
internal fun DataBackupScreen(
    context: Context,
    onBack: () -> Unit,
    onExport: suspend (OutputStream) -> MovoBackupSummary,
    onImport: suspend (InputStream) -> MovoBackupSummary,
) {
...
private fun defaultBackupFileName(): String =
    "Movo-backup-${SimpleDateFormat("yyyyMMdd-HHmm", Locale.US).format(Date())}.movo-backup.json"
