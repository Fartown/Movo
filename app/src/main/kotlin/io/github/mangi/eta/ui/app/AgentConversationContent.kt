...
internal fun AgentConversationContent(
    ...
    fun leaveThen(messageId: String, mutate: () -> Unit) {
        ...
        leaveScope.launch {
            kotlinx.coroutines.delay((io.github.mangi.eta.ui.theme.MovoMotion.FAST_EXIT + io.github.mangi.eta.ui.theme.MovoMotion.STANDARD).toLong())
            try {
                mutate()
            } finally {
                leavingMessages -= messageId
    ...
    CompositionLocalProvider(
        io.github.mangi.eta.ui.components.LocalLeavingMessages provides leavingMessages,
