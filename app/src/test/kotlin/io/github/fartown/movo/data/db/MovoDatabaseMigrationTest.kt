...
@Config(sdk = [36])
class MovoDatabaseMigrationTest {
    @Test
    fun migration6To21PreservesDataAndMovesCompleteConversationContext() {
        ...
        val migration16To17WithMcpData = Migration(16, 17) { database ->
            MovoDatabase.MIGRATION_16_17.migrate(database)
            database.execSQL(
        ...
        val database = Room.databaseBuilder(context, MovoDatabase::class.java, databaseName)
            .addMigrations(
                MovoDatabase.MIGRATION_6_7,
                MovoDatabase.MIGRATION_7_8,
                MovoDatabase.MIGRATION_8_9,
                MovoDatabase.MIGRATION_9_10,
                MovoDatabase.MIGRATION_10_11,
                MovoDatabase.MIGRATION_11_12,
                MovoDatabase.MIGRATION_12_13,
                MovoDatabase.MIGRATION_13_14,
                MovoDatabase.MIGRATION_14_15,
                MovoDatabase.MIGRATION_15_16,
                migration16To17WithMcpData,
                MovoDatabase.MIGRATION_17_18,
                MovoDatabase.MIGRATION_18_19,
