...
class AgentRuntimeHistoryReducerTest {
    ...
    fun journalRetainsOriginalsAndContextIncludesPostSnapshotSteps() {
        ...
        val snapshot = io.github.fartown.movo.agent.model.AgentContextSnapshot(operationId = "run", messages = listOf(summary),
    ...
    fun editingSummarizedTurnRebuildsFromOriginalJournal() {
        ...
        val state = AgentChatUiState(listOf(
            io.github.fartown.movo.ui.model.UserMessageUi("u1", "原始指令"),
            io.github.fartown.movo.ui.model.UserMessageUi("u2", "后续问题"),
    ...
    fun replacementKeepsLaterUserMessagesAndIsAppliedOnce() {
        ...
        val snapshot = io.github.fartown.movo.agent.model.AgentContextSnapshot(
    ...
    fun snapshotKeepsAcceptedButUnconsumedSteeringAfterCancellation() {
        val initial = AgentChatUiState(
            messages = listOf(
                io.github.fartown.movo.ui.model.UserMessageUi("user-run-supplement-1", "已消费"),
                io.github.fartown.movo.ui.model.UserMessageUi("user-run-supplement-2", "待消费"),
