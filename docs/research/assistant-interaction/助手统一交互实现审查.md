...
前提：没有正在运行的语音服务，用户从系统电源键/助手手势进入，`autoListen=false`，`AgentAccessibilityService.current()` 为 null。`VoiceEntry:28–31` 使用 startForegroundService 启动 ACTION_SHOW；`MovoAssistantVoiceService:165–169` 只打开界面后返回，既不 startForeground，也不 stopSelf。onCreate 只 attach，START_NOT_STICKY 也不结束服务。系统要求服务在数秒内转前台，否则抛 `ForegroundServiceDidNotStartInTimeException`。[Android 官方契约](https://developer.android.com/develop/background-work/services/fgs/troubleshooting#foregroundservicedidnotstartintimeexception) 这是源码与平台契约确认的崩溃路径，未在设备触发。
...
- `MovoAssistantVoiceService.dismiss` 被独立进程 VIS 调用时，仅操作该进程的 manager，没有向主进程发送结束命令；主进程声音不会被该调用结束。通知的 ACTION_END_VOICE 是另一条可用路径。这是当前函数声明与跨进程行为不符，不能据此推导所有收起动作都应结束声音。
...
| 章节 | 文件 | 关键职责与位置 |
|---|---|---|
| 4 / F1 / F7 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/session/VoiceEntry.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/session/VoiceEntry.kt) | 23–32 系统入口及前台服务启动 |
| 4 / F1 / F7 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoAssistantVoiceService.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoAssistantVoiceService.kt) | 78–109 promote；164–211 截图与展示；215–216 前台短路；269–271 本地 dismiss |
| 4 / F1 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoVoiceInteractionSession.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoVoiceInteractionSession.kt) | 39–51 入口和关闭调用 |
| 4 / 7.2 | `app/src/main/AndroidManifest.xml` [打开](../../../app/src/main/AndroidManifest.xml) · `app/src/main/kotlin/io/github/fartown/movo/MovoApp.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/MovoApp.kt) | 独立进程声明 109–113；主进程初始化 50–59 |
| F2 / F5 / F6 / F9 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/session/VoiceSessionManager.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/session/VoiceSessionManager.kt) | 74–85 绑定；148–184 drain/dispatch；194–234 result；240–269 Host |
| F2 / F3 / F4 / F6 / F8 | `app/src/main/kotlin/io/github/fartown/movo/ui/app/AgentAppState.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/app/AgentAppState.kt) | 838–866 切会话；978–1054 语音；1056–1106 文字提交 |
| F3 | `app/src/main/kotlin/io/github/fartown/movo/ui/screens/chat/AgentChatScreen.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/screens/chat/AgentChatScreen.kt) · `app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentConversationDraftStore.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentConversationDraftStore.kt) | composer 的会话 key 与按 key 创建草稿 |
| F2 / F4 | `app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentChatBody.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentChatBody.kt) | 867 全局状态；949–952 切模式再发送 |
| F3 / F4 / F8 | `app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentChatInputBar.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentChatInputBar.kt) | 142–165 本地稿；288–304 编辑；386–398 发送/停止 |
| F5 / F9 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/VoiceConversationController.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/VoiceConversationController.kt) · `app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/VoiceTurnCoordinator.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/VoiceTurnCoordinator.kt) | Controller 107–117、146–149；Coordinator 141–144、177–189 |
| F5 / F9 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/DoubaoDialogEngine.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/DoubaoDialogEngine.kt) | 365–391 异步关闭与主线程回调 |
| F7 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/session/VoiceSurfaceTracker.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/session/VoiceSurfaceTracker.kt) · `app/src/main/kotlin/io/github/fartown/movo/ui/app/AgentAppRoot.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/app/AgentAppRoot.kt) | resumed 计数；341–343 / 554–568 非聊天路由 |
| 3 / 7.2 | `app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentVoiceStatusStrip.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentVoiceStatusStrip.kt) · `app/src/main/kotlin/io/github/fartown/movo/ui/AgentConversationSheetActivity.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/ui/AgentConversationSheetActivity.kt) | 操作、独立字幕和复用聊天窗口 |
| 3 / 5 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/VoiceReplyContent.kt` [打开](../../../app/src/main/kotlin/io/github/fartown/movo/agent/voice/conversation/VoiceReplyContent.kt) | 7–8 成功最终正文过滤 |
