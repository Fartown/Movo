...
`MovoWakeWordController` 根据开关和麦权限启动 `MovoWakeWordService`；`WakeEngineFactory` 固定选 Sherpa。Sherpa 检出词后先停止并释放自己的 `AudioRecord`，回调仅带 `phrase`，没有采样位置或 PCM。
...
`MovoAsrSessionFactory` 固定豆包，没有失败后切系统识别。`SaucAudioStream` 串行分配序号并发送首包/音频包/末包，结束操作幂等。
...
| wake 冷却 | 2500 ms | MovoMicSessionCoordinator |
| wake 关闭 | 当前立即停采集并 stopSelf | MovoWakeWordService |
...
| UI phase | READY / PROCESSING / ERROR；listening 另存 | MovoVoicePanel / Overlay |
...
| 章节 | 文件 | 关键符号/职责 |
|---|---|---|
| 3、4、5 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoWakeWordService.kt` | 39、46–193、270–317：实例协调器、前台服务、wake转交 |
| 4、5、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoMicSessionCoordinator.kt` | 11–86：阶段、冷却、未接入电话方法 |
| 4、5、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/wake/SherpaWakeEngine.kt` | 153–204：独立采集与phrase回调 |
| 3、4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/MovoAssistantOverlayService.kt` | 279–330、457–547、810–885：识别、提交、取消、隐藏 |
| 3、4 | `app/src/main/kotlin/io/github/fartown/movo/ui/components/AgentChatBody.kt` | 1172–1206：聊天final自动提交 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/asr/MovoAsrSessionFactory.kt` | 7–69：固定豆包与会话身份过滤 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/asr/MovoAsrEngine.kt` | 6–17：listener契约 |
| 4、5 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/asr/DoubaoBidirectionalAsrEngine.kt` | 44–234：WS、采集、停止、尾结果 |
| 4、5、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/asr/AsrPcmCapture.kt` | 23–101：独立AudioRecord |
| 4、5 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/asr/SaucAudioStream.kt` | 9–36：发送排序和唯一末包 |
| 4、5 | `app/src/main/kotlin/io/github/fartown/movo/agent/voice/asr/DoubaoSaucProtocol.kt` | 138–164、183、225–295：请求、句数据、尾帧 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/runtime/AgentEvent.kt` | 86–133：正文/思考/工具和replacement |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/model/AgentLoop.kt` | 153–228、254–280：工具回合、最终正文、取消检查 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/model/AgentModelClient.kt` | 195–207、283–295：取消快照与消息DTO |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/runtime/AgentRuntimeWire.kt` | 150–161、206–218、493–540：请求/结果序列化 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/model/AgentContextSnapshot.kt` | 8–17：上下文快照 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/runtime/AgentRuntimeSession.kt` | 134–174：唯一终态 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/ui/app/AgentRuntimeHistoryReducer.kt` | 15–47：history/journal及run幂等 |
| 4、6 | `app/src/main/kotlin/io/github/fartown/movo/agent/runtime/AgentRunCheckpointStore.kt` | 111–120：运行快照 |
| 5、6 | `app/src/main/kotlin/io/github/fartown/movo/data/model/VoiceSettings.kt` | ASR参数、认证与wake设置 |
| 6 | `app/src/main/kotlin/io/github/fartown/movo/hook/xiaoai/XiaoAiStreamRenderer.kt` | 162–180：私有TTS反射 |
